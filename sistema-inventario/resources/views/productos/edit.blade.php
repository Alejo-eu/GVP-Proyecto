            ...
            <form method="POST" action="{{ route('productos.update', $producto) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h5 class="mb-3">Stock Actual por Almacén</h5>
                        ...
                        @foreach($almacenes as $almacen)
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-md-4">
                                    <input type="number" 
                                           class="form-control" 
                                           value="{{ $inventarioActual[$almacen->id]->cantidad ?? 0 }}" 
                                           readonly
                                           disabled>
                        ...
                        <div class="alert alert-info mt-3 mb-0">
                            ...
                            Para ajustar el stock, usa el botón de ajuste en el listado de productos.
                        </div>
                    </div>
                </div>
