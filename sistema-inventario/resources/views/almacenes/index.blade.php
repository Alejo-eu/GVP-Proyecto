...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Gestiona tus almacenes y sucursales</p>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div class="d-flex align-items-center">
                                <div class="avatar-lg bg-light rounded p-3 me-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                @if($almacen->activo)
                                    <form action="{{ route('almacenes.toggle-status', $almacen) }}" 
                                          method="POST" 
                                          class="d-inline"
                                          onsubmit="return confirm('¿Estás seguro de desactivar este almacén?')">
                                        @csrf
                                        @method('PUT')
                                ...
                                @else
                                    <form action="{{ route('almacenes.toggle-status', $almacen) }}" 
                                          method="POST" 
                                          class="d-inline"
                                          onsubmit="return confirm('¿Estás seguro de activar este almacén?')">
                                        @csrf
                                        @method('PUT')
    ...
    @else
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5">
                ...
                <h5 class="mt-3">No hay almacenes</h5>
                <p class="text-muted">Comienza agregando tu primer almacén</p>
                <a href="{{ route('almacenes.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>
                    Nuevo Almacén
                </a>
